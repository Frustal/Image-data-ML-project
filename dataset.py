...
def get_dataset(data_dir, val_split=0.2, test_split=0.1, random_seed=1245):
    # load dataset
    full_dataset = ImagesDataset(data_dir)
    ...
    train_dataset, val_dataset, test_dataset = random_split(
        full_dataset, [train_size, val_size, test_size], generator=torch.Generator().manual_seed(random_seed))
